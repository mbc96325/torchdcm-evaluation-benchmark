...
APOLLO_MNL_SCRIPT = ROOT / "experiments" / "apollo" / "R" / "run_generic_mnl.R"
APOLLO_MIXED_SCRIPT = ROOT / "experiments" / "apollo" / "R" / "run_generic_mixed_estimate.R"
...
def write_outputs(rows: list[dict], profile: str) -> tuple[Path, Path]:
    ...
    json_path = RESULTS / f"generated_choice_battery_{profile}.json"
    md_path = RESULTS / f"generated_choice_battery_{profile}.md"
