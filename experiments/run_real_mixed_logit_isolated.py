...
def main() -> None:
    ...
    parser.add_argument("--json-output", type=Path, default=RESULTS / "mixed_real_battery_single_core.json")
    parser.add_argument("--md-output", type=Path, default=RESULTS / "mixed_real_battery_single_core.md")
